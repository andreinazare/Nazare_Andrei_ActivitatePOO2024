...
int main(){
    ...
    cofetarii.pushback(new CofetarieOnline("Delicii","Dorobanti"));
    cofetarii.pushfron(new Cofetarie("Dulcinella"));

    for(list<Cofetarie*>::iterator i=cofetarii.begin(); i != cofeatrii.end(); i++){
